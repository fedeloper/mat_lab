...
_CN.ASPAN.MATCH_COARSE.THR = 0.7
...
_CN.TRAINER.RANSAC_PIXEL_THR = 0.0
...
_CN.ASPAN.COARSE.COARSEST_LEVEL= [36,36]
_CN.ASPAN.COARSE.TRAIN_RES = [832,832]
_CN.ASPAN.COARSE.TEST_RES = [1152,1152]
_CN.ASPAN.MATCH_COARSE.MATCH_TYPE = 'dual_softmax'
...
_CN.TRAINER.ADAMW_DECAY = 0.1
_CN.ASPAN.MATCH_COARSE.TRAIN_COARSE_PERCENT = 0.3
