...
_CN.MATCHFORMER = CN()
_CN.MATCHFORMER.BACKBONE_TYPE = 'litela'# litela,largela,litesea,largesea
...
_CN.MATCHFORMER.MATCH_COARSE.THR = 0.0
...
_CN.MATCHFORMER.BACKBONE_TYPE = 'litesea'
_CN.MATCHFORMER.SCENS = 'outdoor'
_CN.MATCHFORMER.RESOLUTION = (8,4)
