...
def drawMatches(img1, kp1, img2, kp2):
    ...
    for x in range(len(kp1)):
        ...
        # colour blue
        #print(x1,y1)
        ax.add_patch(plt.Circle((x1, y1), 4, color='blue', fill=False))
        ax.add_patch(plt.Circle((x2 + cols1, y2), 4, color='blue', fill=False))

        # Draw a line in between the two points
        # thickness = 1
        # colour blue
        line = mlines.Line2D([x1, x2 + cols1], [y1, y2], linewidth=1, color='blue')
        ax.add_line(line)
